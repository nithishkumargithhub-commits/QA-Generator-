        ...
        {loading ? (
          ...
          <div className="py-10 space-y-4">
            {isConnected && connectedEmail ? (
              /* Connected via Gmail/App Account but no real courses — guide to OAuth */
              <div className="p-6 rounded-2xl bg-amber-950/20 border border-amber-500/30 space-y-4 text-center">
                <AlertTriangle className="w-10 h-10 text-amber-400 mx-auto" />
                <div>
                  <h3 className="text-base font-bold text-amber-300">Connected as {connectedEmail}, but no courses loaded</h3>
                  <p className="text-xs text-slate-400 mt-2 max-w-lg mx-auto leading-relaxed">
                    Your account is linked, but Gmail Password / App Account login <strong className="text-slate-200">cannot access the Google Classroom API directly</strong>.
                    To load your real courses and assignments, you must authorize via <strong className="text-white">Google OAuth</strong>.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
                  ...
                  >
                    ...
                    Sign In with Google OAuth (Required)
                  </button>
                  <button
                    onClick={handleDisconnect}
                ...
                <p className="text-[10px] text-slate-500">
                  Google OAuth securely grants access to your Classroom data without storing your password.
                </p>
              </div>
            ) : (
              ...
              <div className="py-8 text-center space-y-3">
                ...
                <p className="text-xs text-slate-500 max-w-md mx-auto">
                  Sign in with your Google account via OAuth to load your real Google Classroom courses and assignments.
                </p>
                <div className="flex items-center justify-center gap-3 pt-2">
                  <button
                    onClick={handleGoogleOAuthLogin}
                    className="bg-white text-slate-900 px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow hover:scale-105 transition-all"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                      <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
